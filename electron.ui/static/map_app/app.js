...
var map_layer = new OpenLayers.Layer.OSM("Local Tiles", path_base + "map_app/tiles/${z}/${x}/${y}.png");
...
var feature = new OpenLayers.Feature.Vector(
		  ...
		  { externalGraphic: path_base+'map_app/img/star_plane.png', 
...
function changePlaneLoc(lon, lat, hdg) {
    ...
    feature.style.externalGraphic = path_base+'map_app/img/track_pixel.png';
	...
	{description:'X-8 Plane for AUVSI Competition'},
	            {externalGraphic: path_base+'map_app/img/airplane.png',
...
function createStationaryObsticle(lon, lat, height, rad) {
    ...
    obst = new OpenLayers.Feature.Vector(
	   ...
	   map.getProjectionObject()),
	       ...
	       {externalGraphic: path_base+'map_app/img/cylinder_obst.png',
    ...
    wayp = new OpenLayers.Feature.Vector(
	      new OpenLayers.Geometry.Point(lon, lat).transform(new OpenLayers.Projection("EPSG:4326"),
              map.getProjectionObject()),
	            ...
	            {externalGraphic: path_base+'map_app/img/waypoint.icons/'+seq+'.png',
...
function createMovingObsticle(lon, lat, size, id) {
    ...
    obst_mov = new OpenLayers.Feature.Vector(
		   ...
		   {externalGraphic: path_base+'map_app/img/sphere_obst.png', 
